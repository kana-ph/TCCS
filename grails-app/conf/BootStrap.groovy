...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def admin = new User(firstName: 'I', middleName: 'am', lastName: 'admin', username: 'admin', password: 'password', email: 'kenichigouang@gmail.com', position: 'administrator', department: 'admin').save(failOnError: true, flush: true)
        def head1 = new User(firstName: 'head', middleName: 'of', lastName: 'department', username: 'head1', password: 'password', email: 'head1@yopmail.com', position: 'department head', department: 'App Dev').save(failOnError: true, flush: true)
